...
class TestSquare_instantiation(unittest.TestCase):
    """Unittests to test instantiation of the Square class."""
...
class TestSquare_size(unittest.TestCase):
    """Unittests to test size initialization of the Square class."""
...
class TestSquare_x(unittest.TestCase):
    """Unittests to test initialization of Square x attribute."""
...
class TestSquare_y(unittest.TestCase):
    """Unittests to test initialization of Square y attribute."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittests to test order of Square attribute initialization."""
...
class TestSquare_area(unittest.TestCase):
    """Unittests to test the area method of the Square class."""
...
class TestSquare_stdout(unittest.TestCase):
    """Unittests to test __str__ and display methods of Square class."""

    @staticmethod
    def capture_stdout(sq, method):
        """Captures & returns text printed to stdout.
...
class TestSquare_update_args(unittest.TestCase):
    """Unittests to test update args method of the Square class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unittests to test update kwargs method of Square class."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unittests to test to_dictionary method of the Square class."""
