...
class Rectangle:
    ...
    @property
    def width(self):
        """ set/get width for/of our Rectangle. """
        return self.__width
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        will return our Rectangle with greater area.
        Args:
            rect_1 (Rectangle): 1st Rectangle.
            rect_2 (Rectangle): 2nd Rectangle.
        Raises:
            TypeError: when none of(rect_1/ rect_2) is a Rectangle.
        """
    ...
    def __str__(self):
        ...
        -repr our rectangle with a '#' char.
        """
        if self.__width == 0 or self.__height == 0:
            return ("")
    ...
    def __del__(self):
        """ print something when our Rectangle is being deleted"""
        type(self).number_of_instances -= 1
        print("Bye rectangle...")
